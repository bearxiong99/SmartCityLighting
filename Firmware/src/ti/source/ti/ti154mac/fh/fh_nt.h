...
#define FH_NT_TEMP_TABLE_SIZE          MAX_DEVICE_TABLE_ENTRIES
#else
/*! Maximum number of fixed Nodes */
#define FH_NT_TEMP_TABLE_SIZE          (10)
#endif
...
typedef struct nt_hnd_s
{
  ...
  uint8_t                   maxNumNonSleepNodes;   /*<! Maximum number of nonSleep Node */
  uint8_t                   maxNumSleepNodes;      /*<! Maximum number of Sleep Node */
  uint8_t                   numNonSleepNode;       /*<! number of active non-sleepy node */
  uint8_t                   numSleepNode;          /*<! number of active sleepy node */
...
{
    sAddrExt_t  addr[FH_NT_TEMP_TABLE_SIZE];
    uint8_t     num_node;
} FHNT_TEMP_TABLE_s;
...
MAC_INTERNAL_API sAddrExt_t *FHNT_getEUI(uint8_t index);

MAC_INTERNAL_API uint8_t FHNT_AddDeviceCB(sAddrExt_t *pEUI, uint8_t devIndex);
MAC_INTERNAL_API uint8_t FHNT_DelDeviceCB(sAddrExt_t *pEUI, uint8_t devIndex);
