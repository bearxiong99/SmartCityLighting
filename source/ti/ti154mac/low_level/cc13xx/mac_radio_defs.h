...
#define MAC_RADIO_SET_IEEE_ADDR(p)                    osal_memcpy( macFrmFilter.localExtAddr, p, 8 )
...
/*--------Source Matching------------*/
#define MAC_RADIO_TURN_ON_AUTO_ACK()                  /* Nothing for CC13xx */
...
#define MAC_SPEC_USECS_PER_BACKOFF                    (macSpecUsecsPerSymbol * MAC_A_UNIT_BACKOFF_CCA_PERIOD)
