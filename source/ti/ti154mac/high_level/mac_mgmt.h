...
typedef uint8_t (*fhAddDeviceCB)(sAddrExt_t *pEUI, uint8_t devIndex);
typedef uint8_t (*fhDelDeviceCB)(sAddrExt_t *pEUI, uint8_t devIndex);
typedef uint8_t (*fhGetTxChHopFn_t)(void);
typedef uint32_t (*fhGetRemDTFn_t)(void);
typedef void (*fhUpdateCCA)(uint8_t macTxType);
typedef uint32_t (*fhGetCCATime)(void);
...
/* Action sets */
extern macAction_t macMgmtAction1[8];
